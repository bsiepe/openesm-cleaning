...
df <- df_raw |>
  ...
  dplyr::rename(
    ...
    true_self = dn01_06,
    connected = dn01_07,
    mastered_challenges = dn01_08,
    intimacy = dn01_09,
    pressure = dn02_01,
    told_what_to_do = dn02_02,
    unappreciated = dn02_03,
    disagreements_conflicts = dn02_04,
    even_hard_things = dn02_05,
    against_own_will = dn02_06,
    did_stupid = dn02_07,
    struggled = dn02_08,
    did_interesting = dn02_09,
...
# Create metadata ---------------------------------------------------------
write_metadata("0072", meta_data = meta_data, variable_data = variable_data)